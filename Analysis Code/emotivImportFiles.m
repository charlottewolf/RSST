...
%% Input
% Data Input
    path = "/Users/charlottewolf/Downloads/";
    file = "nobody_test1_EPOCX_168388_2022.10.13T15.01.23.07.00.csv";
    plotTitle = "csvmarker test"; % title
    ...
    columnToAnalyze = 11; % used for .dat files
    currentFreq = 260; % used for .dat files
    ...
    datasetEnd = 0; % ending datapoint in seconds
